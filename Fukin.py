#coding=utf-8
#!/usr/bin/python2
#Originally Written By MR HASnAt
try:
    import os,sys,time,datetime,re,random,hashlib,threading,json,getpass,urllib,cookielib,requests
    from multiprocessing.pool import ThreadPool
except ImportError:
    os.system("pip2 install requests")
    os.system("python2 Targit.py")
os.system("clear")
"""
try:
    my = requests.get("https://MRShehZadaMuGhaL")
...
#MyLogo
def logo():
    os.system('echo -e "█MR DaNisH░\n██Trusted Facebook Dealer\n█USAid M4L49G\n HAsNat KhAn║ \n██║M4L49G\n\n-----------------------------------------------\n\n➣ Codded By : HASNAT KHan\n➣ Facebook  : HAsnAt KhAn\n➣ Github    : https://github.com/hasnatmalang\n➣ Devolper   : HAsnAt KhAn\n\n-----------------------------------------------" | lolcat')
def method_menu():
    os.system("clear")
    logo()
    print("")
